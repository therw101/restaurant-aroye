      ...
      >
        ...
        {socialLinks.map((social, index) => (
          <motion.a
            ...
            className={`w-14 h-14 rounded-full bg-background border border-border text-foreground shadow-lg hover:shadow-xl transition-all flex items-center justify-center ${social.color} hover:text-white`}
